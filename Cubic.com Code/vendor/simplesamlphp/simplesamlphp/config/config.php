...
$config['technicalcontact_name'] = "Steve Rifkin";
$config['technicalcontact_email'] = "steve@freshform.com";

// Change these for your installation.
$config['secretsalt'] = '6QTU2riUqJcQCrZh67yoqcDpUif/oHRrVrbYo/xp/RU=';
$config['auth.adminpassword'] = 'MdBxXaCdZihc';

// enable SAML20
$config['enable.saml20-idp'] = TRUE;

$config['session.cookie.domain'] = '.cubic.com';
$config['session.cookie.secure'] = true;
$config['session.cookie.http_post'] = true;
...
require_once('acquia_helpers.php');
